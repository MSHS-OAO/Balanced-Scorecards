...
>>>>>>> 263b36d0698284ef972d6a0f20bcf7f06feec456
                                                multiple = FALSE,
                                                options = pickerOptions(
                                                  liveSearch = TRUE,
                                                  actionsBox = TRUE,
                        ...
                        tabPanel("Operational Metrics - Case Management/Social Work",
                                 ...
                                 tabBox(title = NULL, id = "tabset8", width = "100%", type = 'pills',      
                                        tabPanel("Operational Metrics",
                                                 ...
                                                 hr(),
                                                 br(),
                                                 fileInput("case_management_los",
                                                           label = "Please upload LOS data"),
                                                 hr(),
                                                 br(),
                                                 fileInput("case_management_readm",
                                                           label = "Please upload Re Admission data"),
                                                 hr(),
