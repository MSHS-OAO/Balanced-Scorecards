...
-- YTD Actual Annualized
    ...
    (
            SELECT FUNCTION, MONTH, EXPTYPE, (YTD_ACTUAL/MONTH_NUMBER) * 12 AS YTD_ACTUAL_ANNUALIZED, YEAR_BUDGET  FROM(
    ...
    UNION ALL
            SELECT FUNCTION, MONTH, 'Total Expenses' AS EXPTYPE, (YTD_ACTUAL/MONTH_NUMBER) * 12 AS YTD_ACTUAL_ANNUALIZED, YEAR_BUDGET FROM(
